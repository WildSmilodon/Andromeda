...
//
Point(111) = {0,0,z2,lcar1};
Point(112) = {r2,0,z2,lcar1};
Point(113) = {0,r2,z2,lcar1};
Point(114) = {-r2,0,z2,lcar1};
Point(115) = {0,-r2,z2,lcar1};
//
...
Sphere(1112) = {0, 0, zpos, Rp};
ReverseMesh Surface{130}; // this was automatic in v2 mesh, in v4 it is not
MeshSize{126,127} = lcarP;

Physical Surface("spredaj") = {6}; 
Physical Surface("stena") = {122,123,124,125,127,117,118,119,120};
Physical Surface("zadaj") = {121};
Physical Surface("particle") = {130};
//+
